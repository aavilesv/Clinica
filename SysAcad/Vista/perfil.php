...
<body>
  ...
  if (isset($_GET['opc'])) {
    switch ($_GET['opc']) {
      ...
      $id=$registros->__get('id');
      $usuario=$registros->__get('usuario');
      $nombre=$registros->__get('nombre');
      $apellido=$registros->__get('apellido');
      $pass=$registros->__get('clave');
      $hidden='hidden';
      $disabled = '';
      break;
      case 'ver':
      ...
      $rol=$registros->__get('idRol');
      $foto=$registros->__get('foto');
      $hidden='';
      $disabled = 'disabled';
      break;
    }
          ...
          <div class="row-fluid">
            <div class="span12">
              <ul class="breadcrumb">
                ...
                <li><a href="javascript:window.location.reload();" class="active">Perfil Usuario</a> <span class="divider">/</span></li>
              </ul>
            </div>
          </div>
                    ...
                    <div class="col-lg-10">
                      <form class="form-horizontal" name="frmUsuario"  method="post" action="InterfazUsuario.php">
                        ...
                        <center>
                          <div class="form-group">
                            <div class="col-md-9">
                              <?php echo '<img class="img-responsive img-circle col-sm-offset-4" src="'.$foto.'" width="300px">'; ?>
                            </div>
                          </div>
                        </center>
