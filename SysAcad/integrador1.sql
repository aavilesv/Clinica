...
-- Volcando datos para la tabla integrador1.comtbcab_compra: ~4 rows (aproximadamente)
...
-- Volcando datos para la tabla integrador1.comtbcab_devolucion: ~2 rows (aproximadamente)
/*!40000 ALTER TABLE `comtbcab_devolucion` DISABLE KEYS */;
INSERT INTO `comtbcab_devolucion` (`idDevolucion`, `numeroOrden`, `f_devolucion`, `empleado`, `descripcion`) VALUES
...
-- Volcando datos para la tabla integrador1.comtbdet_compra: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla integrador1.comtbdet_devolucion: ~0 rows (aproximadamente)
...
INSERT INTO `comtbproducto` (`idProducto`, `nombreProd`, `f_venc`, `f_elab`, `precio`, `stock`, `imagen`, `estado`) VALUES
	(1, 'Paracetamol', '2022-02-05', '2018-02-05', 0.915, 11, 'paracetamol.png', 1),
	(2, 'Finalin', '2018-02-24', '2015-02-01', 0.25, 1, 'finalin.jpg', 1),
	(3, 'Redoxon', '2020-08-24', '2018-02-05', 0.75, 10, 'redoxon.jpg', 1),
	(4, 'Ensure Advanced', '2020-07-30', '2014-07-02', 1.7, 11, 'ensure advance.jpg', 1),
	(5, 'Albendazol', '2019-09-25', '2015-09-25', 0.55, 11, 'albendazol.jpg', 1),
	(6, 'LemonFlu', '2022-11-23', '2017-11-24', 1.2, 10, 'lemonflu.jpg', 1),
	(7, 'Neurobion', '2020-07-25', '2016-07-14', 3, 18, 'neurobion.jpg', 1),
	(8, 'Pharmaton', '2022-10-01', '2016-10-01', 3.25, 9, 'pharmaton.jpg', 1);
...
-- Volcando datos para la tabla integrador1.faccabfac: ~8 rows (aproximadamente)
...
INSERT INTO `faccliente` (`FACCliId`, `FACCliNombre`, `FACCliApellido`, `FACCliCedula`, `FACCliDireccion`, `FACCliCelular`, `FACCliEmail`, `FACCliUsuarioCrea`, `FACCliUsuaModif`, `FACCliEstado`, `FACCliFechaCrea`, `FACCliFechaFechaUltima`) VALUES
	...
	(11, 'Jose', 'Cardenas', '0987654454', '5454', '5454', '5454', '', '', b'1', '0000-00-00', '0000-00-00'),
...
-- Volcando datos para la tabla integrador1.facdetfac: ~11 rows (aproximadamente)
...
-- Volcando datos para la tabla integrador1.profesional: ~4 rows (aproximadamente)
...
INSERT INTO `segmodulo` (`idModulo`, `modNombre`, `modDescripcion`, `modFoto`, `codigo`, `color`, `modPadre`, `estado`) VALUES
	(1, 'Seguridad', 'Grupo Seguridad', ' fa-lock', 'Apps/main/vista/seguridad.php', 'primary', 0, NULL),
	(2, 'Ortodoncia', 'Odontologia', 'fa-flask', 'Apps/main/vista/ortodoncia.php', 'green', 0, NULL),
	(3, 'Farmacia', 'Compra y venta', 'fa-plus-square-o  ', 'Apps/main/vista/farmacia.php', 'red', 0, NULL),
	(4, 'Proveedores', 'Grupo proveedores', 'fa-ambulance', 'Apps/seguridad/farmacia/vista/ListarProveedor.php', 'primary', 3, NULL),
	(5, 'Productos', 'Nuevos Productos', 'fa-stethoscope', 'Apps/seguridad/Farmacia/Vista/ListarProducto.php', 'red', 3, NULL),
	(6, 'Compras', 'Nuevas Compras', 'fa-shopping-cart', 'Apps/seguridad/Farmacia/Vista/ListarCompra.php', 'green', 3, NULL),
	(7, 'Devoluciones', 'Nuevas Deoluciones', 'fa-history', 'Apps/seguridad/Farmacia/Vista/ListarDevolucion.php', 'yellow', 3, NULL),
	(8, 'Factura', 'Grupo Facturas', 'fa-file-text-o', 'Apps/seguridad/modulo/Factura/Vista/ListarFacturas.php', 'success', 3, NULL),
	(9, 'Clientes', 'Grupo Clientes', 'fa-github', 'Apps/seguridad/modulo/Factura/Vista/ListarCliente.php', 'warnig', 3, NULL),
	(10, 'Insumos', 'Grupo Insumos', 'fa-stethoscope', 'Apps/seguridad/ortodoncia/vista/ListarInsumos.php', 'green', 2, NULL),
	(11, 'Clinica', 'Herramientas', 'fa-hospital-o', 'Apps/seguridad/ortodoncia/vista/ListarClinicas.php', 'primary', 2, NULL),
	(12, 'Consulta', 'Grupo Consulta', 'fa-bell', 'Apps/seguridad/ortodoncia/vista/ListarConsultas.php', 'red', 2, NULL),
	(13, 'Usuario', 'Grupo Usuario', 'fa-users', 'Apps/seguridad/usuario/vista/ListarUsuarios.php', NULL, 1, NULL),
	(14, 'Permisos', 'Asignacion', 'fa-glass', 'Apps/Seguridad/permisos/vista/ListarPermisos.php', NULL, 1, NULL),
	(15, 'Roles', 'Muestra Roles', 'fa-retweet', 'Apps/Seguridad/rol/Vista/Listarroles.php', NULL, 1, NULL),
	(16, 'Modulos', 'Muestra Modulos', 'fa-inbox', 'Apps/Seguridad/modulos/vista/listarmodulos.php', NULL, 1, NULL),
	(17, 'Historia Clinica', 'Grupos Resgistros', 'fa-medkit', 'Apps/seguridad/HistoriaClinica/Vista/ListarUsuariosCitas.php', 'yellow', 0, NULL),
	(18, 'Citas', NULL, 'fa-user-md', 'AppCita/Apps/Cita/Vista/ListarCita.php', NULL, NULL, NULL),
	(19, 'Consultas', NULL, NULL, 'Apps/Consulta/Vista/ListarConsulta.php', NULL, NULL, NULL);
...
INSERT INTO `segrol` (`idRol`, `rolDescripcion`) VALUES
	(1, 'administrador'),
	(3, 'ginecologo'),
	(2, 'odontologo'),
	(4, 'pediatra'),
...
INSERT INTO `segusuario` (`idLogin`, `usuLogin`, `usuClave`, `usuNombre`, `usuApellido`, `email`, `idRol`, `last_session`, `foto`, `token`, `token_usuClave`, `usuClave_request`, `activacion`) VALUES
	...
	(0058, 'lpalmaa', '123', 'Lady', 'Palma', 'jcardenasp2@unemi.edu.ec', 43, '2018-02-02 04:33:50', '../../../../fotos/foto_20151027151735.JPG', '0', '', 1, 0),
	(0060, 'jvinuezam', '123', 'Jorge', 'Vinueza', 'marco5284@hotmail.com', 1, '2018-02-14 05:57:04', '../../../../fotos/foto_2016831142828.jpg', '0', '', 1, 0),
...
-- Volcando datos para la tabla integrador1.seg_rolmodulo: ~5 rows (aproximadamente)
