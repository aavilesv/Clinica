...
include_once('../Controlador/DevolucionCTR.php');

$product = new DevolucionDAO();
$cart = new DevolucionCTR();
...
<head>
  <meta charset="utf-8">
  <title>Lista de Devolucion</title>
  <?php
  $rutaValidacion="../../../../";
  $rutaFoto="../../";
  $ruraPerfil="../../";
  ...
  ?>
  <script type="text/javascript" src="../js/functionsDev.js"></script>
</head>
    ...
    <div class="container-fluid bg-warning">
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="row-fluid">
            <div class="span12">
              <ul class="breadcrumb list-group-item-warning">
                ...
                <li><a href="javascript:window.location.reload();" class="active"><i class="fa fa-history"></i> Devoluciones</a> <span class="divider">/</span></li>
              </ul>
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-lg-12">
              <h1 class="page-header"><i class="fa fa-history"></i> Lista de Devolucion</h1>
            </div><!-- /.col-lg-12 -->
          </div><!-- /.row -->

          <div class="container-fluid">
            <div class="row">
              <div class="panel panel-default panel-table panel-yellow">
                <div class="panel panel-heading">
                <br>

                <div class="row"> <!-- Criterios de Búsqueda-->
                  <div class="col col-md-12 col-xs-12">
                    <form method="post" action="InterfazDevolucion.php">
                      <div class="form-row">
                      ...
                      <div class="form-row">
                        ...
                        <div class="col col-xs-12 col-md-4 mb-3">
                          <div class="form-group">
                            <div class="input-group">
                              <span class="input-group-addon">Orden de Devolucion</span>
                              <input id="empleado" type="text" class="form-control" name="empleado"  disabled value=<?php echo 'DV00'.$product->generaOrden(); ?>>
                            </div>
                          </div>
                        </div>
                      </div><!--Fin form row 2-->
                          ...
                          <div class="form-group">
                            <div class="btn-group">
                              <div class="col-md-2 col-md-offset" >
                                  <button id="btnEnviar" type="submit" class=" btn btn-danger "><span class="fa fa-history"></span> Devolver</button>
                              </div>
                              <div class="col-md-2 col-md-offset-3">
                                  <a href='InterfazDevolucion.php?prod=0&opc=cancelar' class="btn btn-primary col-md-offset-0" name="button" role="button"><span class="glyphicon glyphicon-remove"></span> Cancelar</a>
                              </div>
                            </div>
                          </div>
                        </div>
            ...
            <div class="panel-body">
                  ...
                  <table class="table table-bordered table-hover table-condensed table-fixed">
                    <thead class="bg-warning">
                      <tr class="productsHeader">
                        <th colspan="6" style="text-align:center" style="color: orange">Lista de productos</th>
                      </tr>
                      <tr>
                        <th>Producto</th>
                        <th>Existencia</th>
              ...
              <div class="col-6">
                <div class="col-sx-6 col-md-6 table-responsive">
                  <table class="table table-bordered table-hover table-condensed table-fixed">
                    <thead class="cartHeader bg-danger" display="off">
                      <tr>
                        <th colspan="6" style="text-align:center">Productos a devolver <i class="glyphicon glyphicon-ban-circle"><i/></th>
                        </tr>
                        <tr>
                          <th colspan="3">Total dinero entrante: <?= $cart->get_total_payment(); ?></th>
                          <th colspan="6">Total items: <?= $cart->get_total_items(); ?></th>
                        </tr>
                      </thead>
