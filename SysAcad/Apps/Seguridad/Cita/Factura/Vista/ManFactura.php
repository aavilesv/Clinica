                ...
                <div class="container-fluid">
                  <div class="span12">
                    <ul class="breadcrumb">
                      ...
                      <li><a href= " <?php echo $ruta;?>Apps/Seguridad/modulo/Factura/Vista/ListarFacturas.php">Lista de Factura</a><span class="divider"></span></li>
                      <li><a href="javascript:window.location.reload();" class="active">Nueva Factura</a> <span class="divider">/</span></li>
                    </ul>
                  </div>
                    ...
                    <div class="col-xs-12">
                      ...
                      <div class="row">
                        <div class="col-xs-4">
                          <div class="form-group">
                            <label>Cliente:</label>
                            <select class="chosen-select form-control" id="cboCliente" name="cboCliente" <?php echo $disable; ?> >
...
$(document).on('click', '#btnsend', function(event) {
  if (validaCmbTipCli() == false || validaCmbCliente() == false || validaTabla() == false){
    event.preventDefault();
  }else {
    this.submit();
  }
