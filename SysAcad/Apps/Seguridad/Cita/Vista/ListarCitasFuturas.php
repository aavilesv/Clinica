            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <h1 class="page-header">Citas Futuras</h1>
                            </div><!-- /.col-lg-12 -->
                        </div><!-- /.row -->
                                        ...
                                        <div class="row"><!-- Cuerpo de Tabla-->
                                            <div class="col-sx-12 col-md-12 table-responsive">
                                                ...
                                                if (count($registros) > 0) {
                                                        ...
                                                        <tbody>
                                                            ...
                                                            foreach ($registros as $registro) {
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    ?>
                                                                    <td>
                                                                        <a rel="tooltip" title="Editar Cita" href='ManCita.php?usua=<?php echo $registro->__get('CIT_Id'); ?>&opc=editar1&pac=<?php echo $registro->__get('aux'); ?>&pacNo=<?php echo $registro->__get('PAC_Id'); ?>&pro=<?php echo $registro->__get('aux1'); ?>&proNo=<?php echo $registro->__get('PRO_Id'); ?>'
                                                                        ...
                                                                        <a  rel="tooltip" title="Ver Registro" href='ManCita.php?usua=<?php echo $registro->__get('CIT_Id'); ?>&opc=ver2&pac=<?php echo $registro->__get('aux'); ?>&pacNo=<?php echo $registro->__get('PAC_Id'); ?>&pro=<?php echo $registro->__get('aux1'); ?>&proNo=<?php echo $registro->__get('PRO_Id'); ?>'
                                                    ...
                                                    echo "<br><p class='alert alert-danger'>No existen citas futuras</p>";
                                                }
                                                ?>
                                            </div>
                                        </div>
...
<script type="text/javascript">
    ...
    $(".delete-button").click(function () {
        ...
        if (confirm("Estas seguro, deseas eliminar este registro -> " + ficha.toUpperCase() + " <- ?")) {
            $(".delete-button").attr("href", "InterfazCita.php?id=" + Id + "&opc=eliminarCompleto2");
        } else {
            return false;
        }
    });
